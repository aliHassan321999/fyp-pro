                ...
                <Card variant="lg" className="p-10 rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-slate-100 bg-white animate-in slide-in-from-right-4 duration-300 max-w-2xl mx-auto block">
                  ...
                  <div className="space-y-6 mb-12 bg-[#F8FAFC] p-8 rounded-[1.5rem] border-2 border-slate-100">
                    ...
                    <div className="pt-6 border-t border-slate-200">
                      <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 flex items-center gap-2"><Zap className="w-4 h-4" /> Department & Priority Assignment</p>
                      <div className="bg-white p-5 rounded-2xl border border-slate-200/60 shadow-sm flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center"><Zap className="w-5 h-5 animate-pulse" /></div>
                        <div>
                          <p className="font-bold text-slate-800">Pending AI Classification</p>
                          <p className="text-sm font-medium text-slate-400">Our AI system will automatically classify the department and determine the priority level upon submission.</p>
                        </div>
                      </div>
                    </div>
