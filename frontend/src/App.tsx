...
import DepartmentStaffPerformancePage from '@pages/Department/StaffPerformancePage';
import DepartmentStaffDetailPage from '@pages/Department/StaffDetailPage';
import DepartmentAddStaffPage from '@/pages/Department/AddStaffPage';
import DepartmentComplaintsPage from '@pages/Department/ComplaintsPage';
import DepartmentComplaintDetailPage from '@pages/Department/ComplaintDetailPage';
import DepartmentProfilePage from '@pages/Department/ProfilePage';
import DepartmentHelpPage from '@pages/Department/HelpPage';
...
const AppRoutes: React.FC = () => {
  return (
    <Routes>
      ...
      />
      <Route
        path={ROUTES.DEPARTMENT_ADD_STAFF}
        element={
          <ProtectedRoute requiredRole="department_head">
            <DepartmentAddStaffPage />
          </ProtectedRoute>
        }
      />
      <Route
        ...
        element={
          <ProtectedRoute requiredRole="department_head">
            <DepartmentStaffPerformancePage />
          </ProtectedRoute>
        }
      />
      <Route
        path={ROUTES.DEPARTMENT_STAFF_DETAIL}
        element={
          <ProtectedRoute requiredRole="department_head">
            <DepartmentStaffDetailPage />
          </ProtectedRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path={ROUTES.DEPARTMENT_COMPLAINT_DETAIL}
        element={
          <ProtectedRoute requiredRole="department_head">
